...
def ecrire():
    with open('data1.csv', 'a', newline='') as fichier:
        fieldnames = ['prenom', 'nom', 'carte', 'achat', 'date', 'mois', 'crypte']
        ...
        case4r = input()
        print ("Crypte example: 0 1 2 ")
        case5r = input()
        fichier.writerow({'prenom': prenomr , 'nom' : nomr , 'carte' : case1r , 'achat' : case2r , 'date' : case3r, 'mois' : case4r, 'crypte' : case5r })
    print(" ")
def erase():
    print("confirm y/n ?")
    confirm = 0
    ...
    if confirm == "y":
        with open('data1.csv', 'w', newline='') as fichier:
            ...
            fichier = csv.DictWriter(fichier, fieldnames=fieldnames, delimiter=';')
            fichier.writeheader()
            fichier.writerow({'prenom' :'', 'nom' :'' , 'carte' :'' , 'achat': '0' , 'date' :'0', 'mois' : '0', 'crypte' : 0 })
        print(" ")
    else :
        print(" ")
def status(prenomre, nomre, login):
    passed = 0
    achatr = int(0)
    achatt = int(0)
    achatp = int(0)
